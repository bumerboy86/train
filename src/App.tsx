...
import { GameOverBoard } from "./components/GameOverBoard/GameOverBoard.tsx";
import { StartBoard } from "./components/StartBoard/StartBoard.tsx";
        ...
        {!isGame ? (
          ...
          <div className='gameBoard'>
            {!gameOver ? (
              ...
              <GameOverBoard startFn={startGameHandler} tScore={totalScore} />
            )}
